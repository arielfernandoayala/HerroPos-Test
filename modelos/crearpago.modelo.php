...
class ModeloPresupuestoRapido{
	...
	static public function mdlIngresarPresupuestoRapido($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(codigo, id_cliente, id_vendedor, productos, modificacion, neto, total, id_canal_origen) VALUES (:codigo, :id_cliente, :id_vendedor, :productos, :modificacion, :neto, :total, :id_canal_origen)");
