              ...
              <div class="box">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="seleccionarClienteVenta" name="seleccionarClienteVenta" placeholder="CUIT/CUIL/DNI">

                    <input type="hidden" class="form-control" id="seleccionarCliente" name="seleccionarCliente" >
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input class="form-control" name="nombreClienteVenta" id="nombreClienteVenta" value="<?php echo $cliente["nombre"]; ?>" readonly >

                    <span class="input-group-addon"><button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#modalAgregarCliente" data-dismiss="modal">Agregar cliente</button>
                    </span>
                        ...
                        <tr>
                          ...
                          <td style="width: 35%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" class="form-control input-lg"  id="nuevoImpuestoVenta" name="nuevoImpuestoVenta" value="<?php echo $porcentajeImpuesto; ?>" required>
