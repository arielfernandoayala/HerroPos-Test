        ...
        <?php
          ...
          foreach ($clientes as $key => $value) {
            ...
            echo '<tr>
                    ...
                    <td>'.$value["calle"]."-".$value["numero"].'</td>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarCalle" id="editarCalle" placeholder="Ingresar calle" >
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" name="editarNumAltura" id="editarNumAltura" placeholder="Ingresar altura" >
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" name="editarPiso" id="editarPiso" placeholder="N° piso de edificio" >
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarDpto" id="editarDpto" placeholder="Depertamento" >
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" name="editarCP" id="editarCP" placeholder="Codigo Postal" >
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarLocalidad" id="editarLocalidad" placeholder="Localidad" >
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarProvincia" id="editarProvincia" placeholder="Provincia " >
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarFechaNacimiento" id="editarFechaNacimiento"  placeholder="día/mes/año" >
