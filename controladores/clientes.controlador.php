			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nuevoCliente"]) &&
			   preg_match('/^[0-9]+$/', $_POST["nuevoDocumentoId"]) ){
			   	...
			   	$datos = array("nombre"=>$_POST["nuevoCliente"],
					           ...
					           "numero"=>$_POST["nuevoNumAltura"],
					           "piso"=>$_POST["nuevoPiso"],
					           "departamento"=>$_POST["nuevoDpto"],
					           "localidad"=>$_POST["nuevoLocalidad"],
					           "cod_postal"=>$_POST["nuevoCP"],
			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["editarCliente"]) &&
			   preg_match('/^[0-9]+$/', $_POST["editarDocumentoId"]) ){
			   	...
			   	$datos = array("id"=>$_POST["idCliente"],
					           ...
					           "numero"=>$_POST["editarNumAltura"],
					           "piso"=>$_POST["editarPiso"],
					           "departamento"=>$_POST["editarDpto"],
					           "localidad"=>$_POST["editarLocalidad"],
					           "cod_postal"=>$_POST["editarCP"],
